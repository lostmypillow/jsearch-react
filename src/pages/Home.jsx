...
function MobileBar() {
    ...
    return (
        <div className={`flex flex-col md:flex-row items-center justify-center w-screen z-20 fixed bottom-0 md:top-0 left-0  p-4 rounded-xl border-2 border-black bg-white gap-2  ${expanded ? "h-[50vh] md:h-16" : ""} `} >
            <BarLeft>
